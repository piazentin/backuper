...
async def test_backup_analyzer():
    ...
    license_entry = next(e for e in analyzed_entries if e.source_file.relative_path == Path("LICENSE"))
    ...
    text_file_entry = next(e for e in analyzed_entries if e.source_file.relative_path == Path("text_file1.txt"))
    ...
    subdir_entry = next(e for e in analyzed_entries if e.source_file.relative_path == Path("subdir"))
    ...
    starry_night_entry = next(e for e in analyzed_entries if e.source_file.relative_path == Path("subdir/starry_night.png"))
