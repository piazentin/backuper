...
class CryptoTest(unittest.TestCase):
    def test_setup_crypto(self):
        ...
        self.assertEqual({"kek_salt", "dek_base64"}, set(meta.keys()))

    def test_write_read_meta(self):
        written_vars = {"a": '12kjdhgfsjkdr1234"', "b": "aloha  "}
    ...
    def test_derivate_key(self):
        ...
        self.assertEqual(key, crypto.derivate_key(salt, password))
    ...
    def test_encrypt_decrypt_file(self):
        ...
        file_to_encrypt = (
            "./test/resources/bkp_test_sources_new/" "subdir/starry_night.png"
        )
